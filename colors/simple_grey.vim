...
let s:gui.grey3_5 = {'normal':'#444444',}
...
call s:hi("VertSplit", s:gui.grey4, s:gui.none, s:gui.none)
...
call s:hi("Folded", s:gui.grey4, s:gui.none, s:gui.none)
call s:hi("EndOfBuffer", s:gui.grey4, s:gui.none, s:gui.none)
call s:hi("Todo", s:gui.grey4, s:gui.none, s:gui.none)
call s:hi("Linear", s:gui.grey4, s:gui.none, s:gui.none)
call s:hi("CursorLineNR", s:gui.grey4, s:gui.none, s:gui.none)
...
call s:hi("WildMenu", s:gui.red, s:gui.black, s:gui.none)
call s:hi("Visual", s:gui.black, s:gui.grey2, s:gui.none)
call s:hi("Cursor", s:gui.black, s:gui.white,  s:gui.none)
call s:hi("Pmenu", s:gui.none, s:gui.black, s:gui.none)
call s:hi("Pmenusel", s:gui.red, s:gui.black, s:gui.none)
...
call s:hi("StatusLine", s:gui.none, s:gui.black, s:gui.none)
